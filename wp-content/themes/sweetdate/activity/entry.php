			...
			<div class="activity-meta">
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="link secondary fav bp-secondary-action" title="<?php esc_attr_e( 'Mark as Favorite', 'buddypress' ); ?>"><?php _e( 'Favorite', 'buddypress' ); ?></a>

					<?php else : ?>

						<a href="<?php bp_activity_unfavorite_link(); ?>" class="link unfav bp-secondary-action" title="<?php esc_attr_e( 'Remove Favorite', 'buddypress' ); ?>"><?php _e( 'Remove Favorite', 'buddypress' ); ?></a>
