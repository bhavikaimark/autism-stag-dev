	...
	if (is_woocommerce()) {
		...
		switch ($woo_sidebar) {
			case 'right':
				...
				add_filter('kleo_content_class', create_function('', 'return "eight";'));
				break;
			case 'left':
				remove_action('kleo_before_content', 'kleo_sidebar');
				remove_action('kleo_after_content', 'kleo_sidebar');
			...
			case '3ll':
				...
				add_filter('kleo_content_class', create_function('', 'return "six";'));
				break;
			case '3lr':
				remove_action('kleo_before_content', 'kleo_sidebar');
				remove_action('kleo_after_content', 'kleo_sidebar');
			...
			case 'no':
				remove_action('kleo_before_content', 'kleo_sidebar');
				remove_action('kleo_after_content', 'kleo_sidebar');
				add_filter('kleo_content_class', create_function('', 'return "twelve";'));
				break;
			default:
				break;
		}
