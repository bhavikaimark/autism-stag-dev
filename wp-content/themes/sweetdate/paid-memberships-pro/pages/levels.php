...
<div class="row membership">
 ...
 else  
 {
  ...
  <div class="<?php echo $level_cols;?> columns">
    <ul class="pricing-table kleo-level-<?php echo $level->id; ?><?php if ($popular == $level->id) echo ' popular';?>">
      ...
      <li class="cta-button">
        <?php if(empty($current_user->membership_level->ID)) { ?>
          <a class="<?php if ($popular == $level->id) echo 'button radius'; else echo 'button radius small secondary';?>" href="<?php echo pmpro_url("checkout", "?level=" . $level->id, "https")?>"><?php _e('Select', 'kleo_framework');?></a>               
