  ...
  foreach ($kleo_pay_settings as $pays) :
	...
	<tr>
		...
		if ($levels) {
		  ...
		  { 
		  ?>
		  <?php echo $level->name?>: <input type="text" size="2" name="<?php echo KLEO_DOMAIN.'['.$field['id'].']';?>[kleo_pmpro_levels_order][<?php echo $level->id;?>]" value="<?php if(isset($value['kleo_pmpro_levels_order'][$level->id])) echo $value['kleo_pmpro_levels_order'][$level->id]; else echo "0";?>"><br>
		  <?php 
		  }
		}
		?>
